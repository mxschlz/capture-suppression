...
#   Uncomment the one you want to plot, and comment out the other.
# diff_waves = diff_waves_target  # For TARGET difference waves
diff_waves = diff_waves_distractor  # For DISTRACTOR difference waves
# plot_title_prefix = "Target" # if diff_waves is diff_waves_target
plot_title_prefix = "Distractor" # if diff_waves is diff_waves_distractor
