...
# load epochs
epochs = mne.concatenate_epochs([mne.read_epochs(glob.glob(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/epoching/{subject}/eeg/{subject}_task-passive-epo.fif")[0]) for subject in subjects if int(subject.split("-")[1]) in [105, 107]])
# get all conditions
