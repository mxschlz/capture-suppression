...
# read raw fif
raw = mne.io.read_raw_fif(data_path + f"sub-{subject_id}_task-flanker_raw.fif", preload=True)
...
reconst_raw_filt.save(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/preprocessing/sub-{subject_id}/eeg/sub-{subject_id}_task-flanker_raw.fif",
                      overwrite=True)
# save the ica fit
ica.save(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/preprocessing/sub-{subject_id}/eeg/sub-{subject_id}_task-flanker_ica.fif",
         overwrite=True)
# save the indices that were excluded
with open(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/preprocessing/sub-{subject_id}/eeg/sub-{subject_id}_task-flanker_ica_labels.txt", "w") as file:
...
epochs_ar.save(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/epoching/sub-{subject_id}/eeg/sub-{subject_id}_task-flanker-epo.fif",
            overwrite=True)
# save the drop log
log.save(f"/home/max/Insync/schulz.max5@gmail.com/GoogleDrive/PhD/data/SPACEPRIME/derivatives/epoching/sub-{subject_id}/eeg/sub-{subject_id}_task-flanker-epo_log.npz",
         overwrite=True)
