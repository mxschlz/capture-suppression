...
# load up dataframe
df = pd.read_excel("/home/max/data/behavior/wp1/simulated_subjects_appended.xlsx")
# some cleaning
...
plt.savefig("/home/max/figures/wp1/singleton_pres_vs_abs_iscorrect.png", dpi=400)
# plot singleton absent vs present trials
fig = plt.figure(figsize=(15, 8))
barplot_with_single_subjects(df=no_bs, x="SingletonPresent", y="rt", groupby="SingletonPresent")
plt.savefig("/home/max/figures/wp1/singleton_pres_vs_abs_rt.png", dpi=400)
...
plt.savefig("/home/max/figures/wp1/spatial_priming_iscorrect_barplot.png", dpi=400)
# plot priming conditions
fig = plt.figure(figsize=(15, 8))
barplot_with_single_subjects(df=no_bs, x="SpatialPriming", y="rt", groupby="SpatialPriming")
plt.savefig("/home/max/figures/wp1/spatial_priming_rt_barplot.png", dpi=400)
# plot priming conditions
fig = plt.figure(figsize=(15, 8))
barplot_with_single_subjects(df=no_bs, x="IdentityPriming", y="iscorrect", groupby="IdentityPriming")
plt.savefig("/home/max/figures/wp1/identity_priming_iscorrect_barplot.png", dpi=400)
# plot priming conditions
fig = plt.figure(figsize=(15, 8))
barplot_with_single_subjects(df=no_bs, x="IdentityPriming", y="rt", groupby="IdentityPriming")
plt.savefig("/home/max/figures/wp1/identity_priming_rt_barplot.png", dpi=400)
