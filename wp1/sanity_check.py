...
plt.savefig("/home/max/figures/wp1/targetdigit_correct_responses.png", dpi=400)

fig = plt.figure(figsize=(15, 8))
sns.barplot(data=no_bs, x="TargetDigit", y="iscorrect", hue="block")
plt.savefig("/home/max/figures/wp1/targetdigit_correct_responses_block.png", dpi=400)

fig = plt.figure(figsize=(15, 8))
sns.barplot(data=no_bs, x="SingletonPresent", y="iscorrect", hue="block")
plt.savefig("/home/max/figures/wp1/singleton_abs_vs_pres_iscorrect_block.png", dpi=400)

fig = plt.figure(figsize=(15, 8))
sns.barplot(data=no_bs, x="SpatialPriming", y="iscorrect", hue="block")
plt.savefig("/home/max/figures/wp1/spatial_priming_iscorrect_block.png", dpi=400)

fig = plt.figure(figsize=(15, 8))
sns.barplot(data=no_bs, x="IdentityPriming", y="iscorrect", hue="block")
plt.savefig("/home/max/figures/wp1/identity_priming_iscorrect_block.png", dpi=400)
